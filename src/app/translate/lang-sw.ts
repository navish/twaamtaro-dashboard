...
export const LANG_SW_TRANS = {
  ...
  'alert_msg':'Msimu wa mvua umekaribia,unakumbushwa kufanya usafi kwenye mtaro wako',
  ...
  'awareness_msg':'Ni muhimu kusafisha mitaro kila baada ya muda ili kuepuka mafuriko pale mvua zinaponyesha ghafla',
  'modify': 'Badilisha',
  'send_msg': 'Tuma',
